...
public class UnoControllerTest {
    ...
    public void testExceptionHandling() {
        ...
        controller.actionPerformed(new ActionEvent(this, 0, "DRAW"));
        assertTrue("showInfo() should be called on exception", view.infoCalled);
    }
    ...
    static class MockModel extends UnoModel {
        ...
        @Override
        public void playWild(int index, UnoColor color) { playWildCalled = true; }
        ...
        @Override
        public void nextPlayer() { nextPlayerCalled = true; }

        @Override
        public UnoCard peekCardInHand(int index) {
            if (returnNull) return null;
            return isWild ? new UnoCard(UnoColor.WILD, UnoRank.WILD)
                    : new UnoCard(UnoColor.RED, UnoRank.FIVE);
        }
    }

    static class MockView implements UnoView {
        boolean infoCalled = false;
        UnoColor colorToReturn = UnoColor.RED;

        @Override
        public void handleUpdate(List<UnoCard> hand, String top, String player, String info, boolean next) {}

        @Override
        public void handleEnd(String message) {}

        @Override
        public UnoColor promptForWildColor() { return colorToReturn; }

        @Override
        public void showInfo(String message) { infoCalled = true; }
    }
}